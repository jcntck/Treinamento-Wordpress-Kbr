		 ...
		 */
				...
				! function(a, b) {
					...
					function d() {
						...
						function g(a) {
							var c, d, e = a.target,
								f = e.parentElement.previousElementSibling,
						...
						if (!k) {
							...
							if (o)
								for (j = 0; j < o.length; j++) o[j].addEventListener("click", function(a) {
									a.target.select()
								});
							if (m && m.addEventListener("click", function() {
								...
								for (j = 0; j < p.length; j++) p[j].addEventListener("click", f), p[j].addEventListener("keydown", g);
					...
					var g, h, i, j = b.querySelector && a.addEventListener,
						k = !1;
